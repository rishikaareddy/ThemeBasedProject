# Generated by Django 2.1.5 on 2019-04-18 17:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('native_place', models.CharField(choices=[('Hyderabad', 'Hyderabad'), ('Warangal', 'Warangal'), ('Vijayawada', 'Vijayawada'), ('Vizag', 'Vizag'), ('Adilabad', 'Adilabad')], default='Hyderabad', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_id', models.EmailField(max_length=255)),
                ('pass_word', models.CharField(max_length=20)),
                ('language', models.CharField(choices=[('Telugu', 'Telugu'), ('Hindi', 'Hindi'), ('English', 'English'), ('Spanish', 'Spanish')], default='English', max_length=10)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], default='Male', max_length=7)),
                ('phone_number', models.CharField(default='', max_length=10, unique=True)),
        ...
        migrations.AddField(
            ...
            name='guide_username',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testapp.Guide_Registration'),
        ),
        migrations.AddField(
            model_name='guide_booking_model',
            name='tourist_username',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testapp.Tourist_Registration'),
        ),
